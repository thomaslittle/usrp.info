...
export function UserNav() {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 z-40 md:left-auto md:top-4 md:right-4">
                        ...
                        <Popover open={open} onOpenChange={setOpen}>
                            <PopoverTrigger asChild>
                                ...
                                >
                                    <UserAvatar
                                        user={userProfile}
                                        className="w-9 h-9 border-2 border-purple-500 hover:border-violet-400 transition-all"
                                    />
                                    {isHovered && (
                            ...
                            <PopoverContent
                                sideOffset={8}
                                align="end"
                                className="bg-gray-800/50 backdrop-blur-lg border border-gray-700/50 rounded-xl shadow-xl p-2 min-w-[200px] animate-in fade-in-0 zoom-in-95"
                            >
                                    ...
                                    <div className="px-3 py-2 border-b border-gray-800 mb-1">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-xs text-gray-400 uppercase">{userProfile.role.replace('_', ' ')}</div>
                                            </div>
                                        </div>
                                    </div>
