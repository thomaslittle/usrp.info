...
export default function EMSNotFound() {
    return (
        <DepartmentLayout config={emsConfig} currentPath="/ems">
            <div className="min-h-[calc(100vh-200px)] bg-gray-900 flex items-center justify-center relative overflow-hidden">
                {/* Background Pattern */}
                ...
                <div className="relative z-10 text-center px-6 max-w-2xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                        <Link href="/ems" className="cursor-pointer">
                            ...
                            >
                                <Icon icon="ion:medical" className="mr-2 h-5 w-5" />
                                EMS Home
                            </Button>
                        </Link>

                        <Link href="/ems/sops" className="cursor-pointer">
                            <Button
                                variant="outline"
                                size="lg"
                            ...
                            >
                                <Icon icon="heroicons:book-open-16-solid" className="mr-2 h-5 w-5" />
                                View SOPs
                            </Button>
                        </Link>
                    </div>
                    ...
                    <div className="flex justify-center items-end h-32">
                        <div className="relative">
                            <div className="w-24 h-24 bg-gradient-to-br from-purple-500/20 to-violet-600/20 rounded-full flex items-center justify-center border border-purple-500/30">
                                <Icon icon="ion:medical" className="h-12 w-12 text-purple-400" />
                            </div>
                        </div>
                    </div>
                </div>
