    ...
    return (
        <div className="min-h-screen bg-gray-900 flex items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 text-center px-6 max-w-2xl mx-auto">
                {/* 404 Text */}
                <div className="mb-8">
                    <h1 className="text-9xl font-black text-white mb-4 tracking-wider">
                        404
                    </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                    ...
                    <Link href="/ems" className="cursor-pointer">
                        <Button
                            variant="outline"
                            size="lg"
                        ...
                        >
                            <Icon icon="heroicons:heart-16-solid" className="mr-2 h-5 w-5" />
                            EMS Portal
                        </Button>
                    </Link>
                </div>
                ...
                <div className="flex justify-center items-end h-32">
                    <div className="relative">
                        {/* Placeholder for character - you can replace this with an actual image */}
                        <div className="w-24 h-24 bg-gradient-to-br from-purple-500/20 to-violet-600/20 rounded-full flex items-center justify-center border border-purple-500/30">
                            <Icon icon="heroicons:face-frown-16-solid" className="h-12 w-12 text-purple-400" />
                        </div>
                        {/* Optional: Add a character image here */}
                        {/* <img src="/images/404-character.png" alt="404 Character" className="h-32 object-contain" /> */}
                    </div>
                </div>
            </div>
        </div>
